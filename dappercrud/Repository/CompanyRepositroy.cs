...
{
    public class CompanyRepositroy : ICompanyRepository
    {
        private IDbConnection _db;

        public CompanyRepositroy(IConfiguration configuration)
        {
            _db = new SqlConnection(configuration.GetConnectionString("DefaultConnections"));
        }
